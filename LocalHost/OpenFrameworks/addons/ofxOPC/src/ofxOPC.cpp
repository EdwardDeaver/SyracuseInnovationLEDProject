...
// Modified by Edward Deaver on November 5, 2019.
//
#include "ofxOPC.h"
//--------------------------------------------------------------
// Added fontPathLocation global variable to set the font path.
// --------------------------------------------------------------
void ofxOPC::setup(string address, int port,int _numberOfFadecandys)
{
    fontPathLocation = "OpenSans-Bold.ttf";
    ...
    // If this an example it will use this resource
     labels.load(fontPathLocation, 13);
...
// Pre-conditions: hasItRan is a boolean, screenCapture has been declared.
// Post-conditions: None.
void ofxOPC::beginStage(bool hasItRan)
{
    screenCapture.begin();
    ofPushStyle();
    if(hasItRan){
